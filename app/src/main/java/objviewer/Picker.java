package objviewer; /* must be in same package as app in order to find resources */
/*
...
public class Picker extends android.app.Activity {
    ...
    public static final String LookInID="";
    ...
    public static final String ExtensionID="";
    ...
    public void onCreate (android.os.Bundle ToRestore) {
        ...
        PickerList.clear ();
        {
            final String ExternalStorage=android.os.Environment.getExternalStorageDirectory ().getAbsolutePath ();
            final String Extension=getIntent ().getStringExtra (ExtensionID);
            for (String Here : getIntent ().getStringArrayExtra (LookInID)) {
                final java.io.File ThisDir=new java.io.File ((Here.startsWith ("/") ? "" : ExternalStorage + "/") + Here);
        ...
        ((android.widget.Button) findViewById (R.id.item_select)).setOnClickListener (new View.OnClickListener () {
            public void onClick (View TheView) {
                PickerItem Selected=null;
                for (int i=0; ; ) {
                    if (i == PickerList.getCount ()) break;
                    final PickerItem ThisItem=(PickerItem) PickerListView.getItemAtPosition (i);
                ...
                if (Selected != null) {
                    setResult (android.app.Activity.RESULT_OK, new android.content.Intent ().setData (android.net.Uri.fromFile (new java.io.File (Selected.FullPath))));
                    finish ();
                } /*if*/
            } /*onClick*/
        } /*OnClickListener*/);
    ...
    static class PickerItem {
        ...
        public PickerItem (String FullPath) {
    ...
    class SelectedItemAdapter extends android.widget.ArrayAdapter<PickerItem> {
        ...
        SelectedItemAdapter (android.content.Context TheContext, int ResID, android.view.LayoutInflater TemplateInflater) {
        ...
        @Override
        public View getView (int Position, View ReuseView, android.view.ViewGroup Parent) {
            View TheView=ReuseView;
            if (TheView == null) {
                TheView=TemplateInflater.inflate (ResID, null);
            } /*if*/
            final PickerItem ThisItem=this.getItem (Position);
            ((android.widget.TextView) TheView.findViewById (R.id.select_file_name)).setText (ThisItem.toString ());
            final android.widget.RadioButton ThisChecked=(android.widget.RadioButton) TheView.findViewById (R.id.file_item_checked);
        ...
        class OnSetCheck implements View.OnClickListener {
            ...
            public OnSetCheck (PickerItem TheItem) {
                MyItem=TheItem;
            } /*OnSetCheck*/
            ...
            public void onClick (View TheView) {
                if (MyItem != CurSelected) {
                  /* only allow one item to be selected at a time */
                    ...
                    LastChecked=TheView instanceof android.widget.RadioButton ? (android.widget.RadioButton) TheView : (android.widget.RadioButton) ((android.view.ViewGroup) TheView).findViewById (R.id.file_item_checked);
                    CurSelected=MyItem;
