...
public class BundledSavedState extends AbsSavedState
  ...
  */ {
    ...
    public static final Parcelable.Creator<BundledSavedState> CREATOR=new Parcelable.Creator<BundledSavedState> () {
        public BundledSavedState createFromParcel (Parcel SavedState) {
            final AbsSavedState SuperState=AbsSavedState.CREATOR.createFromParcel (SavedState);
            final Bundle MyState=SavedState.readBundle ();
            return new BundledSavedState (SuperState, MyState);
        } /*createFromParcel*/

        public BundledSavedState[] newArray (int NrElts) {
            return new BundledSavedState[NrElts];
        } /*newArray*/
    } /*Parcelable.Creator*/;
    ...
    public BundledSavedState (Parcelable SuperState, /* result from super.onSaveInstanceState() */
    ...
    public void writeToParcel (Parcel SavedState, int Flags) {
