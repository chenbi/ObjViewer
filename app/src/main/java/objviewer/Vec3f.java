...
public class Vec3f
  /* 3D vectors */ {
    ...
    public float[] to_floats (int nrelts /* 3 or 4 */) {
        float[] v;
        switch (nrelts) {
            case 3:
                v=new float[]{x, y, z};
    ...
    public Vec3f mul (float s) {
        return new Vec3f (x * s, y * s, z * s, w);
    } /*mul*/

    public Vec3f recip () {
        return new Vec3f (1.0f / x, 1.0f / y, 1.0f / z);
    } /*recip*/
    ...
    public Vec3f cross (Vec3f v) {
        return new Vec3f (this.y * v.z - v.y * this.z, this.z * v.x - v.z * this.x, this.x * v.y - v.x * this.y);
    } /*cross*/
    ...
    public float elevation ()
        ...
        return (float) Math.atan2 (z, (float) Math.sqrt (x * x + y * y));
    } /*elevation*/
    ...
    public Vec3f unit () {
        ...
        return new Vec3f (x / abs, y / abs, z / abs);
    } /*unit*/
